...
Although Schema Sleuth can perform partial dumps which can be diff'd, a better free tool to use for that is {SchemaCrawler}[http://schemacrawler.sourceforge.net/].
