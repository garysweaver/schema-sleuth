...
A ruby script (for *nix) to connect to a database and spider the database to find all related records based on the table_name, column_name, and value given.
...
MySQL:
      ...
      ss DBI:Mysql:TESTDB:localhost jdoe passwd user_id 1234

Oracle:

      ss DBI:OCI8://db.acme.org:1234/ACMETEST.WORLD jdoe passwd user_id 1234
...
Sample output:
      ...
      Tables: [["DUAL"], ..., ["SAMPLE_TABLE_A"], ["SAMPLE_TABLE_B"], ["SAMPLE_TABLE_C"], ["SAMPLE_TABLE_D"],      ["SAMPLE_TABLE_E"], ...]
      SAMPLE_TABLE_A
